...
A free, sarcastic API service providing 1,000+ creative ways to decline requests. Perfect for people who need help setting boundaries, or just appreciate the art of professional rejection.

## What Is This?

NoaaS is an HTTP API that returns creative rejection responses across four categories:
...
- **Completely Free** - No credit card, no signup, no value proposition
...
A: Yes. Completely free. Forever. No catch. Which should make you suspicious, but here we are.
...
**Q: Is there an SLA?**
A: This is a free service. Your expectations should be calibrated accordingly.
